...
public final class PropertyValidator {
     ...
     *     
     * @param email
     * @return true si el par�metro que se le pasa es un e-mail correcto o una cadena vac�a
     */
    public static boolean validateEmail (String email){        	
    	if (email.equals("")){
    		...
    		Pattern p = Pattern.compile(IConstantes.EXPRESION_EMAIL);
    ...
    public static boolean validateDNI_NIE (String dni){        	
    	if (dni.equals("")){
    		return true;
    	}
    	else{
    		Pattern p = Pattern.compile(IConstantes.EXPRESION_NIF_NIE);
