...
<%@ page import="es.sdweb.application.controller.actionforms.brainLearning.ObtenerCualidadesForm" %>
...
<% ObtenerCualidadesForm frm = (ObtenerCualidadesForm) GestorInformacionWeb.getAttributeObj(request, "obtenerCualidadesForm"); %>
...
<html>
	<head>
		...
		<title><fmt:message key="obtener.cualidades" /></title>
	...
	<body onload="inicializa();" class="obtener_cualidades table-body">
		<div class="container-fluid">
			<div class="row row-30">
				<div class="row menugrande">
					<fmt:message key="obtener.cualidades" />
				</div>
			</div>
			...
			<div class="row">
				<div class="filter-form">
					<div class="row">
						<html:form styleId="obtenerCualidadesForm" action="/ObtenerCualidades.do?accion=procesar" method="post">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoEntrada" name="obtenerCualidadesForm" rows="10" styleClass="inputObligatorio" styleId="textoEntrada"></html:textarea>
									</div>
								</div>

								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoSalida" name="obtenerCualidadesForm" rows="10" styleClass="" disabled="true" styleId="textoSalida"></html:textarea>
									</div>
								</div>
							</div>
					...
					<div class="row row-50">
						...
						<div class="col-md-6 button-row">
				        		<button type="button" id="obtenerCualidadesLimpiar" class="boton_secundario" onClick="limpiarTexto();"><fmt:message key="boton.limpiar"/></button>
				        		<button type="button" id="obtenerCualidadesLink" class="botones_estandar" onClick="obtenerCualidades();"><fmt:message key="boton.obtener.cualidades"/></button>
						</div>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript">
			...
			// onClick del botón obtenerCualidades
		  	function obtenerCualidades() {
				document.getElementById('obtenerCualidadesForm').submit();
			}
