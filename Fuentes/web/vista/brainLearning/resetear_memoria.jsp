...
<html>
	<head>
		...
		<title><fmt:message key="resetear.memoria" /></title>
		...
		<div class="container-fluid">
			<div class="row row-30">
				<div class="row menugrande">
					<fmt:message key="resetear.memoria" />
				</div>
			</div>
				...
				<div class="filter-form">
					...
					<div class="row row-50">
						...
						<div class="col-md-6 button-row">
				        		...
				        		<button type="button" id="resetearMemoriaLink" class="botones_estandar" onClick="resetearMemoria();"><fmt:message key="boton.resetear.memoria"/></button>
						</div>
					</div>
				</div>
			</div>
