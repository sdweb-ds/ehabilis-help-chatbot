...
<%@ page import="es.sdweb.application.controller.actionforms.brainLearning.ObtenerAntonimosForm" %>
...
<% ObtenerAntonimosForm frm = (ObtenerAntonimosForm) GestorInformacionWeb.getAttributeObj(request, "obtenerAntonimosForm"); %>
...
<html>
	<head>
		...
		<title><fmt:message key="obtener.antonimos" /></title>
	...
	<body onload="inicializa();" class="obtener_antonimos table-body">
		<div class="container-fluid">
			<div class="row row-30">
				<div class="row menugrande">
					<fmt:message key="obtener.antonimos" />
				</div>
			</div>
			...
			<div class="row">
				<div class="filter-form">
					<div class="row">
						<html:form styleId="obtenerAntonimosForm" action="/ObtenerAntonimos.do?accion=procesar" method="post">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoEntrada" name="obtenerAntonimosForm" rows="10" styleClass="inputObligatorio" styleId="textoEntrada"></html:textarea>
									</div>
								</div>

								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoSalida" name="obtenerAntonimosForm" rows="10" styleClass="" disabled="true" styleId="textoSalida"></html:textarea>
									</div>
								</div>
							</div>
					...
					<div class="row row-50">
						...
						<div class="col-md-6 button-row">
				        		<button type="button" id="obtenerAntonimosLimpiar" class="boton_secundario" onClick="limpiarTexto();"><fmt:message key="boton.limpiar"/></button>
				        		<button type="button" id="obtenerAntonimosLink" class="botones_estandar" onClick="obtenerAntonimos();"><fmt:message key="boton.obtener.antonimos"/></button>
						</div>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript">
			...
			// onClick del botón obtenerAntonimos
		  	function obtenerAntonimos() {
				document.getElementById('obtenerAntonimosForm').submit();
			}
