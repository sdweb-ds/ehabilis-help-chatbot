...
<%@ page import="es.sdweb.application.controller.actionforms.brainLearning.ObtenerSubclasesForm" %>
...
<% ObtenerSubclasesForm frm = (ObtenerSubclasesForm) GestorInformacionWeb.getAttributeObj(request, "obtenerSubclasesForm"); %>
...
<html>
	<head>
		...
		<title><fmt:message key="obtener.subclases" /></title>
	...
	<body onload="inicializa();" class="obtener_subclases table-body">
		<div class="container-fluid">
			<div class="row row-30">
				<div class="row menugrande">
					<fmt:message key="obtener.subclases" />
				</div>
			</div>
			...
			<div class="row">
				<div class="filter-form">
					<div class="row">
						<html:form styleId="obtenerSubclasesForm" action="/ObtenerSubclases.do?accion=procesar" method="post">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoEntrada" name="obtenerSubclasesForm" rows="10" styleClass="inputObligatorio" styleId="textoEntrada"></html:textarea>
									</div>
								</div>

								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoSalida" name="obtenerSubclasesForm" rows="10" styleClass="" disabled="true" styleId="textoSalida"></html:textarea>
									</div>
								</div>
							</div>
					...
					<div class="row row-50">
						...
						<div class="col-md-6 button-row">
				        		<button type="button" id="obtenerSubclasesLimpiar" class="boton_secundario" onClick="limpiarTexto();"><fmt:message key="boton.limpiar"/></button>
				        		<button type="button" id="obtenerSubclasesLink" class="botones_estandar" onClick="obtenerSubclases();"><fmt:message key="boton.obtener.subclases"/></button>
						</div>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript">
			...
			// onClick del botón obtenerSubclases
		  	function obtenerSubclases() {
				document.getElementById('obtenerSubclasesForm').submit();
			}
