...
<%@ page import="es.sdweb.application.controller.actionforms.brainLearning.CargarFraseForm" %>
...
<% CargarFraseForm frm = (CargarFraseForm) GestorInformacionWeb.getAttributeObj(request, "cargarFraseForm"); %>
...
<html>
	<head>
		...
		<title><fmt:message key="cargar.frase" /></title>
	...
	<body onload="inicializa();" class="cargar_frase table-body">
		<div class="container-fluid">
			<div class="row row-30">
				<div class="row menugrande">
					<fmt:message key="cargar.frase" />
				</div>
			</div>
			...
			<div class="row">
				<div class="filter-form">
					<div class="row">
						<html:form styleId="cargarFraseForm" action="/CargarFrase.do?accion=procesar" method="post">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoEntrada" name="cargarFraseForm" rows="10" styleClass="inputObligatorio" styleId="textoEntrada"></html:textarea>
									</div>
								</div>

								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoSalida" name="cargarFraseForm" rows="10" styleClass="" disabled="true" styleId="textoSalida"></html:textarea>
									</div>
								</div>
							</div>
					...
					<div class="row row-50">
						...
						<div class="col-md-6 button-row">
				        		<button type="button" id="cargarFraseLimpiar" class="boton_secundario" onClick="limpiarTexto();"><fmt:message key="boton.limpiar"/></button>
				        		<button type="button" id="cargarFraseLink" class="botones_estandar" onClick="cargarFrase();"><fmt:message key="boton.cargar.frase"/></button>
						</div>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript">
			...
			// onClick del botón cargarFrase
		  	function cargarFrase() {
				document.getElementById('cargarFraseForm').submit();
			}
