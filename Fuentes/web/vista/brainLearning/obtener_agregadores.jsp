...
<%@ page import="es.sdweb.application.controller.actionforms.brainLearning.ObtenerAgregadoresForm" %>
...
<% ObtenerAgregadoresForm frm = (ObtenerAgregadoresForm) GestorInformacionWeb.getAttributeObj(request, "obtenerAgregadoresForm"); %>
...
<html>
	<head>
		...
		<title><fmt:message key="obtener.agregadores" /></title>
	...
	<body onload="inicializa();" class="obtener_agregadores table-body">
		<div class="container-fluid">
			<div class="row row-30">
				<div class="row menugrande">
					<fmt:message key="obtener.agregadores" />
				</div>
			</div>
			...
			<div class="row">
				<div class="filter-form">
					<div class="row">
						<html:form styleId="obtenerAgregadoresForm" action="/ObtenerAgregadores.do?accion=procesar" method="post">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoEntrada" name="obtenerAgregadoresForm" rows="10" styleClass="inputObligatorio" styleId="textoEntrada"></html:textarea>
									</div>
								</div>

								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoSalida" name="obtenerAgregadoresForm" rows="10" styleClass="" disabled="true" styleId="textoSalida"></html:textarea>
									</div>
								</div>
							</div>
					...
					<div class="row row-50">
						...
						<div class="col-md-6 button-row">
				        		<button type="button" id="obtenerAgregadoresLimpiar" class="boton_secundario" onClick="limpiarTexto();"><fmt:message key="boton.limpiar"/></button>
				        		<button type="button" id="obtenerAgregadoresLink" class="botones_estandar" onClick="obtenerAgregadores();"><fmt:message key="boton.obtener.agregadores"/></button>
						</div>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript">
			...
			// onClick del botón obtenerAgregadores
		  	function obtenerAgregadores() {
				document.getElementById('obtenerAgregadoresForm').submit();
			}
