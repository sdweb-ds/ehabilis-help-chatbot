...
<%@ page import="es.sdweb.application.controller.actionforms.brainLearning.EvaluarFraseForm" %>
...
<% EvaluarFraseForm frm = (EvaluarFraseForm) GestorInformacionWeb.getAttributeObj(request, "evaluarFraseForm"); %>
...
<html>
	<head>
		...
		<title><fmt:message key="evaluar.frase" /></title>
	...
	<body onload="inicializa();" class="evaluar_frase table-body">
		<div class="container-fluid">
			<div class="row row-30">
				<div class="row menugrande">
					<fmt:message key="evaluar.frase" />
				</div>
			</div>
			...
			<div class="row">
				<div class="filter-form">
					<div class="row">
						<html:form styleId="evaluarFraseForm" action="/EvaluarFrase.do?accion=procesar" method="post">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoEntrada" name="evaluarFraseForm" rows="10" styleClass="inputObligatorio" styleId="textoEntrada"></html:textarea>
									</div>
								</div>

								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoSalida" name="evaluarFraseForm" rows="10" styleClass="" disabled="true" styleId="textoSalida"></html:textarea>
									</div>
								</div>
							</div>
					...
					<div class="row row-50">
						...
						<div class="col-md-6 button-row">
				        		<button type="button" id="evaluarFraseLimpiar" class="boton_secundario" onClick="limpiarTexto();"><fmt:message key="boton.limpiar"/></button>
				        		<button type="button" id="evaluarFraseLink" class="botones_estandar" onClick="evaluarFrase();"><fmt:message key="boton.evaluar.frase"/></button>
						</div>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript">
			...
			// onClick del botón evaluarFrase
		  	function evaluarFrase() {
				document.getElementById('evaluarFraseForm').submit();
			}
