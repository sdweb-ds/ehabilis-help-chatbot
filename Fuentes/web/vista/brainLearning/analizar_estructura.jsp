...
<%@ page import="es.sdweb.application.controller.actionforms.brainLearning.AnalizarEstructuraForm" %>
...
<% AnalizarEstructuraForm frm = (AnalizarEstructuraForm) GestorInformacionWeb.getAttributeObj(request, "analizarEstructuraForm"); %>
...
<html>
	<head>
		...
		<title><fmt:message key="analizar.estructura" /></title>
	...
	<body onload="inicializa();" class="analizar_estructura table-body">
		<div class="container-fluid">
			<div class="row row-30">
				<div class="row menugrande">
					<fmt:message key="analizar.estructura" />
				</div>
			</div>
			...
			<div class="row">
				<div class="filter-form">
					<div class="row">
						<html:form styleId="analizarEstructuraForm" action="/AnalizarEstructura.do?accion=procesar" method="post">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoEntrada" name="analizarEstructuraForm" rows="10" styleClass="inputObligatorio" styleId="textoEntrada"></html:textarea>
									</div>
								</div>

								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoSalida" name="analizarEstructuraForm" rows="10" styleClass="" disabled="true" styleId="textoSalida"></html:textarea>
									</div>
								</div>
							</div>
					...
					<div class="row row-50">
						...
						<div class="col-md-6 button-row">
				        		<button type="button" id="analizarEstructuraLimpiar" class="boton_secundario" onClick="limpiarTexto();"><fmt:message key="boton.limpiar"/></button>
				        		<button type="button" id="analizarEstructuraLink" class="botones_estandar" onClick="analizarEstructura();"><fmt:message key="boton.analizar.estructura"/></button>
						</div>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript">
			...
			// onClick del botón analizarEstructura
		  	function analizarEstructura() {
				document.getElementById('analizarEstructuraForm').submit();
			}
