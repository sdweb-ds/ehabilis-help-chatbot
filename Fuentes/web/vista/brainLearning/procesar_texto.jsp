...
<%@ page import="es.sdweb.application.controller.actionforms.brainLearning.ProcesarTextoForm" %>
...
<% ProcesarTextoForm frm = (ProcesarTextoForm) GestorInformacionWeb.getAttributeObj(request, "procesarTextoForm"); %>
...
<html>
	<head>
		...
		<title><fmt:message key="procesar.texto" /></title>
	...
	<body onload="inicializa();" class="procesar_texto table-body">
		<div class="container-fluid">
			<div class="row row-30">
				<div class="row menugrande">
					<fmt:message key="procesar.texto" />
				</div>
			</div>
			...
			<div class="row">
				<div class="filter-form">
					<div class="row">
						<html:form styleId="procesarTextoForm" action="/ProcesarTexto.do?accion=procesar" method="post">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoEntrada" name="procesarTextoForm" rows="10" styleClass="inputObligatorio" styleId="textoEntrada"></html:textarea>
									</div>
								</div>

								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoSalida" name="procesarTextoForm" rows="10" styleClass="" disabled="true" styleId="textoSalida"></html:textarea>
									</div>
								</div>
							</div>
					...
					<div class="row row-50">
						...
						<div class="col-md-6 button-row">
				        		<button type="button" id="procesarTextoLimpiar" class="boton_secundario" onClick="limpiarTexto();"><fmt:message key="boton.limpiar"/></button>
				        		<button type="button" id="procesarTextoLink" class="botones_estandar" onClick="procesarTexto();"><fmt:message key="boton.procesar.texto"/></button>
						</div>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript">
			...
			// onClick del botón procesarTexto
		  	function procesarTexto() {
				document.getElementById('procesarTextoForm').submit();
			}
