...
<%@ page import="es.sdweb.application.controller.actionforms.brainLearning.ObtenerComponentesForm" %>
...
<% ObtenerComponentesForm frm = (ObtenerComponentesForm) GestorInformacionWeb.getAttributeObj(request, "obtenerComponentesForm"); %>
...
<html>
	<head>
		...
		<title><fmt:message key="obtener.componentes" /></title>
	...
	<body onload="inicializa();" class="obtener_componentes table-body">
		<div class="container-fluid">
			<div class="row row-30">
				<div class="row menugrande">
					<fmt:message key="obtener.componentes" />
				</div>
			</div>
			...
			<div class="row">
				<div class="filter-form">
					<div class="row">
						<html:form styleId="obtenerComponentesForm" action="/ObtenerComponentes.do?accion=procesar" method="post">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoEntrada" name="obtenerComponentesForm" rows="10" styleClass="inputObligatorio" styleId="textoEntrada"></html:textarea>
									</div>
								</div>

								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoSalida" name="obtenerComponentesForm" rows="10" styleClass="" disabled="true" styleId="textoSalida"></html:textarea>
									</div>
								</div>
							</div>
					...
					<div class="row row-50">
						...
						<div class="col-md-6 button-row">
				        		<button type="button" id="obtenerComponentesLimpiar" class="boton_secundario" onClick="limpiarTexto();"><fmt:message key="boton.limpiar"/></button>
				        		<button type="button" id="obtenerComponentesLink" class="botones_estandar" onClick="obtenerComponentes();"><fmt:message key="boton.obtener.componentes"/></button>
						</div>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript">
			...
			// onClick del botón obtenerComponentes
		  	function obtenerComponentes() {
				document.getElementById('obtenerComponentesForm').submit();
			}
