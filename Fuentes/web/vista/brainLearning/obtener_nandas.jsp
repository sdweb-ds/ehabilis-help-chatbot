...
<%@ page import="es.sdweb.application.controller.actionforms.brainLearning.ObtenerNandasForm" %>
...
<% ObtenerNandasForm frm = (ObtenerNandasForm) GestorInformacionWeb.getAttributeObj(request, "obtenerNandasForm"); %>
...
<html>
	<head>
		...
		<title><fmt:message key="obtener.nandas" /></title>
	...
	<body onload="inicializa();" class="obtener_nandas table-body">
		<div class="container-fluid">
			<div class="row row-30">
				<div class="row menugrande">
					<fmt:message key="obtener.nandas" />
				</div>
			</div>
			...
			<div class="row">
				<div class="filter-form">
					<div class="row">
						<html:form styleId="obtenerNandasForm" action="/ObtenerNandas.do?accion=procesar" method="post">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoEntrada" name="obtenerNandasForm" rows="10" styleClass="inputObligatorio" styleId="textoEntrada"></html:textarea>
									</div>
								</div>

								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoSalida" name="obtenerNandasForm" rows="10" styleClass="" disabled="true" styleId="textoSalida"></html:textarea>
									</div>
								</div>
							</div>
					...
					<div class="row row-50">
						...
						<div class="col-md-6 button-row">
				        		<button type="button" id="obtenerNandasLimpiar" class="boton_secundario" onClick="limpiarTexto();"><fmt:message key="boton.limpiar"/></button>
				        		<button type="button" id="obtenerNandasLink" class="botones_estandar" onClick="obtenerNandas();"><fmt:message key="boton.obtener.nandas"/></button>
						</div>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript">
			...
			// onClick del botón obtenerNandas
		  	function obtenerNandas() {
				document.getElementById('obtenerNandasForm').submit();
			}
