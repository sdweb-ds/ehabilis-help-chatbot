...
<%@ page import="es.sdweb.application.controller.actionforms.brainLearning.ObtenerRedForm" %>
...
<% ObtenerRedForm frm = (ObtenerRedForm) GestorInformacionWeb.getAttributeObj(request, "obtenerRedForm"); %>
...
<html>
	<head>
		...
		<title><fmt:message key="obtener.red" /></title>
	...
	<body onload="inicializa();" class="obtener_red table-body">
		<div class="container-fluid">
			<div class="row row-30">
				<div class="row menugrande">
					<fmt:message key="obtener.red" />
				</div>
			</div>
			...
			<div class="row">
				<div class="filter-form">
					<div class="row">
						<html:form styleId="obtenerRedForm" action="/ObtenerRed.do?accion=procesar" method="post">
							...
							<div class="row">
								<!--<div class="col-md-6">
									<div class="equal-form big-input">
										<html:hidden property="textoEntrada" name="obtenerRedForm" styleClass="inputObligatorio" styleId="textoEntrada"></html:hidden>
									</div>
								</div>-->

								<div class="col-md-12">
									<div class="equal-form big-input">
										<html:textarea property="textoSalida" name="obtenerRedForm" rows="10" styleClass="" disabled="true" styleId="textoSalida"></html:textarea>
									</div>
								</div>
							</div>
					...
					<div class="row row-50">
						...
						<div class="col-md-6 button-row">
				        		<button type="button" id="obtenerRedLimpiar" class="boton_secundario" onClick="limpiarTexto();"><fmt:message key="boton.limpiar"/></button>
				        		<button type="button" id="obtenerRedLink" class="botones_estandar" onClick="obtenerRed();"><fmt:message key="boton.obtener.red"/></button>
						</div>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript">
			...
			// onClick del botón obtenerRed
		  	function obtenerRed() {
				document.getElementById('obtenerRedForm').submit();
			}
