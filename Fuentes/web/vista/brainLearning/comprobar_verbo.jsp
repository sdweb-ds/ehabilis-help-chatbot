...
<%@ page import="es.sdweb.application.controller.actionforms.brainLearning.ComprobarVerboForm" %>
...
<% ComprobarVerboForm frm = (ComprobarVerboForm) GestorInformacionWeb.getAttributeObj(request, "comprobarVerboForm"); %>
...
<html>
	<head>
		...
		<title><fmt:message key="comprobar.verbo" /></title>
	...
	<body onload="inicializa();" class="comprobar_verbo table-body">
		<div class="container-fluid">
			<div class="row row-30">
				<div class="row menugrande">
					<fmt:message key="comprobar.verbo" />
				</div>
			</div>
			...
			<div class="row">
				<div class="filter-form">
					<div class="row">
						<html:form styleId="comprobarVerboForm" action="/ComprobarVerbo.do?accion=procesar" method="post">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoEntrada" name="comprobarVerboForm" rows="10" styleClass="inputObligatorio" styleId="textoEntrada"></html:textarea>
									</div>
								</div>

								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoSalida" name="comprobarVerboForm" rows="10" styleClass="" disabled="true" styleId="textoSalida"></html:textarea>
									</div>
								</div>
							</div>
					...
					<div class="row row-50">
						...
						<div class="col-md-6 button-row">
				        		<button type="button" id="comprobarVerboLimpiar" class="boton_secundario" onClick="limpiarTexto();"><fmt:message key="boton.limpiar"/></button>
				        		<button type="button" id="comprobarVerboLink" class="botones_estandar" onClick="comprobarVerbo();"><fmt:message key="boton.comprobar.verbo"/></button>
						</div>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript">
			...
			// onClick del botón comprobarVerbo
		  	function comprobarVerbo() {
				document.getElementById('comprobarVerboForm').submit();
			}
