...
<%@ page import="es.sdweb.application.controller.actionforms.brainLearning.ObtenerSinonimosForm" %>
...
<% ObtenerSinonimosForm frm = (ObtenerSinonimosForm) GestorInformacionWeb.getAttributeObj(request, "obtenerSinonimosForm"); %>
...
<html>
	<head>
		...
		<title><fmt:message key="obtener.sinonimos" /></title>
	...
	<body onload="inicializa();" class="obtener_sinonimos table-body">
		<div class="container-fluid">
			<div class="row row-30">
				<div class="row menugrande">
					<fmt:message key="obtener.sinonimos" />
				</div>
			</div>
			...
			<div class="row">
				<div class="filter-form">
					<div class="row">
						<html:form styleId="obtenerSinonimosForm" action="/ObtenerSinonimos.do?accion=procesar" method="post">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoEntrada" name="obtenerSinonimosForm" rows="10" styleClass="inputObligatorio" styleId="textoEntrada"></html:textarea>
									</div>
								</div>

								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoSalida" name="obtenerSinonimosForm" rows="10" styleClass="" disabled="true" styleId="textoSalida"></html:textarea>
									</div>
								</div>
							</div>
					...
					<div class="row row-50">
						...
						<div class="col-md-6 button-row">
				        		<button type="button" id="obtenerSinonimosLimpiar" class="boton_secundario" onClick="limpiarTexto();"><fmt:message key="boton.limpiar"/></button>
				        		<button type="button" id="obtenerSinonimosLink" class="botones_estandar" onClick="obtenerSinonimos();"><fmt:message key="boton.obtener.sinonimos"/></button>
						</div>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript">
			...
			// onClick del botón obtenerSinonimos
		  	function obtenerSinonimos() {
				document.getElementById('obtenerSinonimosForm').submit();
			}
