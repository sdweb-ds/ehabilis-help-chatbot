...
<%@ page import="es.sdweb.application.controller.actionforms.brainLearning.ObtenerSuperclasesForm" %>
...
<% ObtenerSuperclasesForm frm = (ObtenerSuperclasesForm) GestorInformacionWeb.getAttributeObj(request, "obtenerSuperclasesForm"); %>
...
<html>
	<head>
		...
		<title><fmt:message key="obtener.superclases" /></title>
	...
	<body onload="inicializa();" class="obtener_superclases table-body">
		<div class="container-fluid">
			<div class="row row-30">
				<div class="row menugrande">
					<fmt:message key="obtener.superclases" />
				</div>
			</div>
			...
			<div class="row">
				<div class="filter-form">
					<div class="row">
						<html:form styleId="obtenerSuperclasesForm" action="/ObtenerSuperclases.do?accion=procesar" method="post">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoEntrada" name="obtenerSuperclasesForm" rows="10" styleClass="inputObligatorio" styleId="textoEntrada"></html:textarea>
									</div>
								</div>

								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoSalida" name="obtenerSuperclasesForm" rows="10" styleClass="" disabled="true" styleId="textoSalida"></html:textarea>
									</div>
								</div>
							</div>
					...
					<div class="row row-50">
						...
						<div class="col-md-6 button-row">
				        		<button type="button" id="obtenerSuperclasesLimpiar" class="boton_secundario" onClick="limpiarTexto();"><fmt:message key="boton.limpiar"/></button>
				        		<button type="button" id="obtenerSuperclasesLink" class="botones_estandar" onClick="obtenerSuperclases();"><fmt:message key="boton.obtener.superclases"/></button>
						</div>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript">
			...
			// onClick del botón obtenerSuperclases
		  	function obtenerSuperclases() {
				document.getElementById('obtenerSuperclasesForm').submit();
			}
