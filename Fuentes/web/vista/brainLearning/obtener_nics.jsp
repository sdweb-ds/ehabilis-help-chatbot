...
<%@ page import="es.sdweb.application.controller.actionforms.brainLearning.ObtenerNicsForm" %>
...
<% ObtenerNicsForm frm = (ObtenerNicsForm) GestorInformacionWeb.getAttributeObj(request, "obtenerNicsForm"); %>
...
<html>
	<head>
		...
		<title><fmt:message key="obtener.nics" /></title>
	...
	<body onload="inicializa();" class="obtener_nics table-body">
		<div class="container-fluid">
			<div class="row row-30">
				<div class="row menugrande">
					<fmt:message key="obtener.nics" />
				</div>
			</div>
			...
			<div class="row">
				<div class="filter-form">
					<div class="row">
						<html:form styleId="obtenerNicsForm" action="/ObtenerNics.do?accion=procesar" method="post">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoEntrada" name="obtenerNicsForm" rows="10" styleClass="inputObligatorio" styleId="textoEntrada"></html:textarea>
									</div>
								</div>

								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoSalida" name="obtenerNicsForm" rows="10" styleClass="" disabled="true" styleId="textoSalida"></html:textarea>
									</div>
								</div>
							</div>
					...
					<div class="row row-50">
						...
						<div class="col-md-6 button-row">
				        		<button type="button" id="obtenerNicsLimpiar" class="boton_secundario" onClick="limpiarTexto();"><fmt:message key="boton.limpiar"/></button>
				        		<button type="button" id="obtenerNicsLink" class="botones_estandar" onClick="obtenerNics();"><fmt:message key="boton.obtener.nics"/></button>
						</div>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript">
			...
			// onClick del botón obtenerNics
		  	function obtenerNics() {
				document.getElementById('obtenerNicsForm').submit();
			}
