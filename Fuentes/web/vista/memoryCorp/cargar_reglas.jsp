...
<%@ page import="es.sdweb.application.controller.actionforms.memoryCorp.CargarReglasForm" %>
...
<% CargarReglasForm frm = (CargarReglasForm) GestorInformacionWeb.getAttributeObj(request, "cargarReglasForm"); %>
...
<html>
	<head>
		...
		<title><fmt:message key="cargar.reglas" /></title>
	...
	<body onload="inicializa();" class="cargar_reglas table-body">
		<div class="container-fluid">
			<div class="row row-30">
				<div class="row menugrande">
					<fmt:message key="cargar.reglas" />
				</div>
			</div>
			...
			<div class="row">
				<div class="filter-form">
					<div class="row">
						<html:form styleId="cargarReglasForm" action="/CargarReglas.do?accion=procesar" method="post">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoEntrada" name="cargarReglasForm" rows="10" styleClass="inputObligatorio" styleId="textoEntrada"></html:textarea>
									</div>
								</div>

								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoSalida" name="cargarReglasForm" rows="10" styleClass="" disabled="true" styleId="textoSalida"></html:textarea>
									</div>
								</div>
							</div>
					...
					<div class="row row-50">
						...
						<div class="col-md-6 button-row">
				        		<button type="button" id="cargarReglasLimpiar" class="boton_secundario" onClick="limpiarTexto();"><fmt:message key="boton.limpiar"/></button>
				        		<button type="button" id="cargarReglasLink" class="botones_estandar" onClick="cargarReglas();"><fmt:message key="boton.cargar.reglas"/></button>
						</div>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript">
			...
			// onClick del botón cargarReglas
		  	function cargarReglas() {
				document.getElementById('cargarReglasForm').submit();
			}
