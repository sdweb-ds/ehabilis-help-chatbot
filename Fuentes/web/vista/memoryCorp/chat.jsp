...
<%@ page import="es.sdweb.application.controller.actionforms.brainLearning.ResetearMemoriaForm" %>
...
<% ResetearMemoriaForm frm = (ResetearMemoriaForm) GestorInformacionWeb.getAttributeObj(request, "resetearMemoriaForm"); %>
...
<html>
	<head>
		...
		<title><fmt:message key="chat" /></title>
		...
		<link rel="stylesheet" href="<%= request.getContextPath() %>/static/css/chat/styles_old_browsers.css">
		<link rel="stylesheet" href="<%= request.getContextPath() %>/static/css/chat/styles.css">
	</head>
	<body onload="inicializa();" class="resetear_memoria table-body">
		<div class="container-fluid">
			<div class="row row-30">
				<div class="row menugrande">
					<fmt:message key="chat" />
				</div>
			</div>
			...
			<div class="row">
				<div class="filter-form">
					<div class="row">
<!--
						<html:form styleId="resetearMemoriaForm" action="/ResetearMemoria.do?accion=procesar" method="post">
...
-->
								<!--<div class="col-md-6">
									<div class="equal-form big-input">
										<html:hidden property="textoEntrada" name="resetearMemoriaForm" styleClass="inputObligatorio" styleId="textoEntrada"></html:hidden>
									</div>
								</div>-->
<!--
								<div class="col-md-12">
									<div class="equal-form big-input">
										<html:textarea property="textoSalida" name="resetearMemoriaForm" rows="10" styleClass="" disabled="true" styleId="textoSalida"></html:textarea>
									</div>
								</div>
							</div>
...
-->
						<div class="row">
							<div id="chat">
								<div id="contenedor">
									<div id="primer-mensaje"></div>
									<div id="reciente-mensaje"></div>
								</div>
								<div id="acciones" >
									<input type="text" id="userInput" placeholder="Escribe un mensaje...">
									<button id="button" onclick="sendMessage()">Enviar</button>
								</div>
								<div id="scrollBottom"><a href="#" onclick="bottomFunction()" title="Ir al mensaje más reciente"><img src="static/images/chat/scroll_top.png"/></a></div>
							</div>
						</div>
...
<!--
						<div class="col-md-6 button-row">
				        		<button type="button" id="resetearMemoriaLimpiar" class="boton_secundario" onClick="limpiarTexto();"><fmt:message key="boton.limpiar"/></button>
				        		<button type="button" id="resetearMemoriaLink" class="botones_estandar" onClick="resetearMemoria();"><fmt:message key="boton.chat"/></button>
						</div>
-->
					</div>
				</div>
		...
		<script type="text/javascript" src="<%= request.getContextPath() %>/static/js/pages/chat/chat.js"></script>
		...
		<script type="text/javascript">
			...
			// onClick del botón resetearMemoria
		  	function resetearMemoria() {
				document.getElementById('resetearMemoriaForm').submit();
			}
			...
			function inicializa() {
				...
				window.chaturl = "<%= request.getContextPath() %>/Chat.do?accion=procesar";
