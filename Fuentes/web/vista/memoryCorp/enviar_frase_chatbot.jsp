...
<%@ page import="es.sdweb.application.controller.actionforms.memoryCorp.EnviarFraseChatBotForm" %>
...
<% EnviarFraseChatBotForm frm = (EnviarFraseChatBotForm) GestorInformacionWeb.getAttributeObj(request, "enviarFraseChatBotForm"); %>
...
<html>
	<head>
		...
		<title><fmt:message key="enviar.frase.chatbot" /></title>
	...
	<body onload="inicializa();" class="enviar_frase_chatbot table-body">
		<div class="container-fluid">
			<div class="row row-30">
				<div class="row menugrande">
					<fmt:message key="enviar.frase.chatbot" />
				</div>
			</div>
			...
			<div class="row">
				<div class="filter-form">
					<div class="row">
						<html:form styleId="enviarFraseChatBotForm" action="/EnviarFraseChatBot.do?accion=procesar" method="post">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoEntrada" name="enviarFraseChatBotForm" rows="10" styleClass="inputObligatorio" styleId="textoEntrada"></html:textarea>
									</div>
								</div>

								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoSalida" name="enviarFraseChatBotForm" rows="10" styleClass="" disabled="true" styleId="textoSalida"></html:textarea>
									</div>
								</div>
							</div>
					...
					<div class="row row-50">
						...
						<div class="col-md-6 button-row">
				        		<button type="button" id="enviarFraseChatBotLimpiar" class="boton_secundario" onClick="limpiarTexto();"><fmt:message key="boton.limpiar"/></button>
				        		<button type="button" id="enviarFraseChatBotLink" class="botones_estandar" onClick="enviarFraseChatBot();"><fmt:message key="boton.enviar.frase.chatbot"/></button>
						</div>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript">
			...
			// onClick del botón enviarFraseChatBot
		  	function enviarFraseChatBot() {
				document.getElementById('enviarFraseChatBotForm').submit();
			}
