...
<%@ page import="es.sdweb.application.controller.actionforms.memoryCorp.VerificarNerForm" %>
...
<% VerificarNerForm frm = (VerificarNerForm) GestorInformacionWeb.getAttributeObj(request, "verificarNerForm"); %>
...
<html>
	<head>
		...
		<title><fmt:message key="verificar.ner" /></title>
	...
	<body onload="inicializa();" class="verificar_ner table-body">
		<div class="container-fluid">
			<div class="row row-30">
				<div class="row menugrande">
					<fmt:message key="verificar.ner" />
				</div>
			</div>
			...
			<div class="row">
				<div class="filter-form">
					<div class="row">
						<html:form styleId="verificarNerForm" action="/VerificarNer.do?accion=procesar" method="post">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoEntrada" name="verificarNerForm" rows="10" styleClass="inputObligatorio" styleId="textoEntrada"></html:textarea>
									</div>
								</div>

								<div class="col-md-6">
									<div class="equal-form big-input">
										<html:textarea property="textoSalida" name="verificarNerForm" rows="10" styleClass="" disabled="true" styleId="textoSalida"></html:textarea>
									</div>
								</div>
							</div>
					...
					<div class="row row-50">
						...
						<div class="col-md-6 button-row">
				        		<button type="button" id="verificarNerLimpiar" class="boton_secundario" onClick="limpiarTexto();"><fmt:message key="boton.limpiar"/></button>
				        		<button type="button" id="verificarNerLink" class="botones_estandar" onClick="verificarNer();"><fmt:message key="boton.verificar.ner"/></button>
						</div>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript">
			...
			// onClick del botón verificarNer
		  	function verificarNer() {
				document.getElementById('verificarNerForm').submit();
			}
