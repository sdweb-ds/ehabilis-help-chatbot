...
<%@ page import="es.sdweb.application.controller.actionforms.memoryCorp.ObtenerReglasForm" %>
...
<% ObtenerReglasForm frm = (ObtenerReglasForm) GestorInformacionWeb.getAttributeObj(request, "obtenerReglasForm"); %>
...
<html>
	<head>
		...
		<title><fmt:message key="obtener.reglas" /></title>
	...
	<body onload="inicializa();" class="obtener_reglas table-body">
		<div class="container-fluid">
			<div class="row row-30">
				<div class="row menugrande">
					<fmt:message key="obtener.reglas" />
				</div>
			</div>
			...
			<div class="row">
				<div class="filter-form">
					<div class="row">
						<html:form styleId="obtenerReglasForm" action="/ObtenerReglas.do?accion=procesar" method="post">
							...
							<div class="row">
								<!--<div class="col-md-6">
									<div class="equal-form big-input">
										<html:hidden property="textoEntrada" name="obtenerReglasForm" styleClass="inputObligatorio" styleId="textoEntrada"></html:hidden>
									</div>
								</div>-->

								<div class="col-md-12">
									<div class="equal-form big-input">
										<html:textarea property="textoSalida" name="obtenerReglasForm" rows="10" styleClass="" disabled="true" styleId="textoSalida"></html:textarea>
									</div>
								</div>
							</div>
					...
					<div class="row row-50">
						...
						<div class="col-md-6 button-row">
				        		<button type="button" id="obtenerReglasLimpiar" class="boton_secundario" onClick="limpiarTexto();"><fmt:message key="boton.limpiar"/></button>
				        		<button type="button" id="obtenerReglasLink" class="botones_estandar" onClick="obtenerReglas();"><fmt:message key="boton.obtener.reglas"/></button>
						</div>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript">
			...
			// onClick del botón obtenerReglas
		  	function obtenerReglas() {
				document.getElementById('obtenerReglasForm').submit();
			}
