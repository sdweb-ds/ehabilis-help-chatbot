...
<%@ page import="es.sdweb.application.controller.actionforms.memoryCorp.ObtenerOntologiaSnomedForm" %>
...
<% ObtenerOntologiaSnomedForm frm = (ObtenerOntologiaSnomedForm) GestorInformacionWeb.getAttributeObj(request, "obtenerOntologiaSnomedForm"); %>
...
<html>
	<head>
		...
		<title><fmt:message key="obtener.ontologia.snomed" /></title>
	...
	<body onload="inicializa();" class="obtener_ontologia_snomed table-body">
		<div class="container-fluid">
			<div class="row row-30">
				<div class="row menugrande">
					<fmt:message key="obtener.ontologia.snomed" />
				</div>
			</div>
			...
			<div class="row">
				<div class="filter-form">
					<div class="row">
						<html:form styleId="obtenerOntologiaSnomedForm" action="/ObtenerOntologiaSnomed.do?accion=procesar" method="post">
							...
							<div class="row">
								<!--<div class="col-md-6">
									<div class="equal-form big-input">
										<html:hidden property="textoEntrada" name="obtenerOntologiaSnomedForm" styleClass="inputObligatorio" styleId="textoEntrada"></html:hidden>
									</div>
								</div>-->

								<div class="col-md-12">
									<div class="equal-form big-input">
										<html:textarea property="textoSalida" name="obtenerOntologiaSnomedForm" rows="10" styleClass="" disabled="true" styleId="textoSalida"></html:textarea>
									</div>
								</div>
							</div>
					...
					<div class="row row-50">
						...
						<div class="col-md-6 button-row">
				        		<button type="button" id="obtenerOntologiaSnomedLimpiar" class="boton_secundario" onClick="limpiarTexto();"><fmt:message key="boton.limpiar"/></button>
				        		<button type="button" id="obtenerOntologiaSnomedLink" class="botones_estandar" onClick="obtenerOntologiaSnomed();"><fmt:message key="boton.obtener.ontologia.snomed"/></button>
						</div>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript">
			...
			// onClick del botón obtenerOntologiaSnomed
		  	function obtenerOntologiaSnomed() {
				document.getElementById('obtenerOntologiaSnomedForm').submit();
			}
